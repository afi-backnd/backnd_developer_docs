...
:::tip 멀티 캐릭터를 사용 중인가요?
원본 · 대상 유저의 계정 소속 여부에 따라 복사 결과가 달라집니다.  
자세한 내용은 [유저 관리 - 멀티 캐릭터 > 유저 복사](/guide/console-guide/backnd-base/users/multi-character#유저-복사)를 참고해 주세요.
:::
