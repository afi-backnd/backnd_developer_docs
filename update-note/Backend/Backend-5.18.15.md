...
[SDK .NET 4 버전] <a href="https://developer.thebackend.io/sdk/unityPackage/5.18.15/Backend-5.18.15.unitypackage" target="_blank">다운로드</a>   
...
- [요청 인증] 숫자로만 구성된 문자열 키가 포함된 Dictionary를 전달할 때 일부 요청에서 401 오류가 발생할 수 있던 문제가 수정되었습니다.
   ...
   - 해당 문제가 수정되었습니다. 5.18.12부터 5.18.14까지의 버전을 사용 중인 프로젝트는 5.18.15로 업데이트해 주세요.
