...
:::caution 지원 종료 안내
* 해당 기능은 5.5.0 버전부터 지원이 중단되었으며, 일시적으로 채팅 서버와 끊어졌을 경우 완전히 연결을 끊고 <a href  = "/sdk-docs/backend/chat/channel-guild/exit/event">OnLeaveGuildChannel</a>핸들러가 호출됩니다.  
:::
...
다른 유저가 길드 채널과 연결이 일시적으로 끊어진 후 다시 연결되었을 때 호출되는 이벤트입니다.  
