...
해당 로그 외에 statusCode : 400, 404, 409 에러등이 발생할 경우에는[Insert 에러케이스](/sdk-docs/backend/base/game-information/insert)를 통해 어떠한 에러로 문제가 발생하였는지 확인할 수 있습니다.  
