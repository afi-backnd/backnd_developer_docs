...
* [BackendReturnObject에서 inDate 조회 함수를 이용하여 inDate 값 확인](/sdk-docs/backend/base/knowhow/object-for-return/get-indate/get-indate-by-function)
* [BackendReturnObject에서 수동으로 inDate 값 확인](/sdk-docs/backend/base/knowhow/object-for-return/get-indate/get-own-indate)
