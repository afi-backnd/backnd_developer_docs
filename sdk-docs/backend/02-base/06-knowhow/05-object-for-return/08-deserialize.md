...
언마샬 한 데이터는 LitJson 라이브러리를 이용하여 손쉽게 디시리얼라이즈 할 수 있습니다.  
> 디시리얼라이즈 기능은 뒤끝에서 제공하는 기능이 아닌 LitJson 라이브러리를 이용한 기능입니다.  
자세한 설명은 [LitJson API](https://litjson.net/api/LitJson)를 확인해 주세요.  
