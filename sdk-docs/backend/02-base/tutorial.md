...
해당 프로젝트는 **Unity 2022.3.62f3**과 **Backend-5.18.10**을 기준으로 개발되었습니다.  

## 유니티 패키지 파일

- <a href="https://developer.thebackend.io/sdk/unityPackage/5.18.10/BackendTutorial.unitypackage" id="download-sdk-base-tutorial">뒤끝베이스 튜토리얼 다운로드</a>
