...
## VSCode C# 확장 설치
뒤끝펑션은 CoreCRL을 통해 프로그램을 실행합니다.  
이를 위해서는 VSCode 내부에 C# 확장이 설치되어있어야합니다.  
 ![image](https://developer.thebackend.io/static/img/bfunc/debugforvscode/extention.png)
...
![image](https://developer.thebackend.io/static/img/bfunc/debugforvscode/1.PNG)
...
- BF Debug Tool(integratedTerminal) : vscode 내에 존재하는 통합 터미널에서 디버깅을 진행합니다.  
- BF Debug Tool(externalTerminal) : 외부 cmd 창 또는 cli 창을 새로 생성하고 디버깅을 진행합니다.  

![image](https://developer.thebackend.io/static/img/bfunc/debugforvscode/2.PNG)

### 디버깅 성공

정상적으로 디버깅 툴 실행에 성공하면 아래 그림과 같이 표시되게 됩니다.  

- **BF Debug Tool(intergratedTerminal)일 경우**  

![image](https://developer.thebackend.io/static/img/bfunc/debugforvscode/3.PNG)

- **BF Debug Tool(externalTerminal)일 경우**  

![image](https://developer.thebackend.io/static/img/bfunc/osx/vscode/debug/mac-debugforvscode-1.png)
...
![image](https://developer.thebackend.io/static/img/bfunc/debugforvscode/4.PNG)
