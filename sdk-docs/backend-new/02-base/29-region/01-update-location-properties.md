...
description: "내 위치로 국가 정보 동기화"
---

# UpdateLocationProperties
public Task< RequestResult > **UpdateLocationPropertiesAsync**();
...
국가 정보는 BackndBase.LocationProperties 내부의 City, Country, Region, Language로 불러올 수 있습니다.  

## Example

### Task 방식
```js
var reqRequest = await BackndLocation.Instance.UpdateLocationPropertiesAsync();

Debug.Log("국가 이름 : " + BackndLocation.Instance.Country);
Debug.Log("도시 이름 : " + BackndLocation.Instance.City);
Debug.Log("지역 이름 : " + BackndLocation.Instance.Region);
Debug.Log("언어 이름 : " + BackndLocation.Instance.Language);
```

### Callback 방식
```js
BackndLocation.Instance.UpdateLocationProperties(callback=>
{
    Debug.Log("국가 이름 : " + BackndLocation.Instance.Country);
    Debug.Log("도시 이름 : " + BackndLocation.Instance.City);
    Debug.Log("지역 이름 : " + BackndLocation.Instance.Region);
