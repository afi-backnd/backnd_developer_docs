...
public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
{
    ...
    // BackndIAP.Google.FromJson 함수를 이용하여 파싱하여 id와 token 값을 추출한 뒤
    // 이를 뒤끝펑션으로 송신해야 합니다.  
    BackndIAP.Google.FromJson(args.purchasedProduct.receipt, out id, out token);
    ...
    // 뒤끝펑션 호출
    BackndFunction.Instance.InvokeFunction("receiptVaildate", param, callback =>
    {
