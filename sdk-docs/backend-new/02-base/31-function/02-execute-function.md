...
public Task< InvokeFunctionResult > **InvokeFunctionAsync**(string **funcName**, Param **body**);
...
var reqRequest = await BackndFunction.Instance.InvokeFunctionAsync("funcName", param);
```
...
BackndFunction.Instance.InvokeFunction("funcName", param, (callback) =>
{
    // 이후 처리
});
```
