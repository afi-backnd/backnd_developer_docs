...
public Task&lt;RequestResult&gt; **CheckNicknameDuplicationAsync**(string **nickname**);
...
### Task 방식
```js
var reqResult = await BackndAuth.Instance.CheckNicknameDuplicationAsync("thebackend");     
...
### Callback 방식
```js
BackndAuth.Instance.CheckNicknameDuplication("thebackend", (callback) =>
{
