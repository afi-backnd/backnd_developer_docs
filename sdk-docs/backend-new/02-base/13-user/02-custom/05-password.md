...
# VerifyPassword
public Task&lt;RequestResult&gt; **VerifyPasswordAsync**(string **CustomGamerPassword**);
...
### Task 방식
```js
var reqResult = await BackndAuth.Instance.VerifyPasswordAsync("1234");
...
### Callback 방식
```js
BackndAuth.Instance.VerifyPasswordAsync("1234", (callback) =>
{
...
### Task 방식
```js
var reqResult = await BackndAuth.Instance.ResetPasswordAsync("CustomGamerId", "help@backnd.com");
```

### Callback 방식
```js
BackndAuth.Instance.ResetPasswordAsync("CustomGamerId" , "help@backnd.com", (callback) =>
{
  // 이후 처리
});
```
...
# ChangePassword
public Task&lt;RequestResult&gt; **ChangePasswordAsync**(string **OldPassword**, string **NewPassword**);
...
### Task 방식
```js
var reqResult = await BackndAuth.Instance.ChangePasswordAsync("OldPassword", "NewPassword");
```

### Callback 방식
```js
BackndAuth.Instance.ChangePasswordAsync("OldPassword", "NewPassword", (callback) =>
{
    // 이후 처리
});
```
