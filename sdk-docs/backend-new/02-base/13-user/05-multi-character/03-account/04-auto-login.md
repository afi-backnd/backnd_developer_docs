...
public Task&lt;RequestResult&gt; **AutoLoginAccountAsync**();
...
### Task 방식
```js
var reqResult = await BackndMultiCharacter.Account.AutoLoginAccountAsync();
...
### Callback 방식
```js
BackndMultiCharacter.Account.AutoLoginAccount((callback) =>
{
