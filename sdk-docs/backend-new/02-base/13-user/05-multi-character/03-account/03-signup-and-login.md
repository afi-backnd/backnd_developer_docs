...
description: "페더레이션 회원가입/로그인"
---

# AuthorizeFederation

public Task&lt;RequestResult&gt; **AuthorizeFederationAsync**(string **federationToken**, FederationType **type**);
...
### Task 방식
```js
var reqResult = await BackndMultiCharacter.Account.AuthorizeFederationAsync("federationToken", FederationType.Google);
...
### Callback 방식
```js
BackndMultiCharacter.Account.AuthorizeFederation("federationToken", FederationType.Google, (callback) =>
{
