...
### Task 방식
```js
var reqResult = await BackndMultiCharacter.Account.UpdateCustomEmailAsync("help@backnd.com");
```

### Callback 방식
```js
BackndMultiCharacter.Account.UpdateCustomEmail("help@backnd.com", (callback) =>
{
    // 이후 처리
});
```
