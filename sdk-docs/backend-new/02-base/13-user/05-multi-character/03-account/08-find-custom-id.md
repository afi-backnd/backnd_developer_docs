...
# FindAccountId
public Task&lt;RequestResult&gt; **FindAccountIdAsync**(string **EmailAddress**);
...
### Task 방식
```js
var reqResult = await BackndMultiCharacter.Account.FindAccountIdAsync("help@backnd.com");
```

### Callback 방식
```js
BackndMultiCharacter.Account.FindAccountId("help@backnd.com", (callback) =>
{
    // 이후 처리
});
```
