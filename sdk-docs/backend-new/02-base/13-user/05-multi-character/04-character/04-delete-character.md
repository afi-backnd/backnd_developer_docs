...
public Task&lt;RequestResult&gt; **DeleteCharacterAsync**(string **uuid**, string **inDate**);
...
### Task 방식
```js
var selectResult = await BackndMultiCharacter.Character.DeleteCharacterAsync(uuid, inDate);
if (selectResult.IsSuccess())
{
    Debug.Log("삭제하였습니다 : " + selectResult.ToString());
}
else
{
    Debug.LogError("삭제에 실패했습니다 : " + selectResult.ToString());
}
```
...
BackndMultiCharacter.Character.GetCharacterList(callback =>
{
    if (callback.IsSuccess())
    {
        ...
        BackndMultiCharacter.Character.DeleteCharacter(uuid, inDate, callback2 =>
        {
            ...
            {
                Debug.LogError("삭제에 실패했습니다 : " + callback2.ToString());
            }
        });                
    }
});
