...
description: "다른 길드 굿즈 정보 조회"
---

# GetGuildGoodsAsync

public Task< GetGuildGoodsResult > **GetGuildGoodsAsync**(string **guildIndate**);
...
```js
var reqResult = await BackndGuild.Instance.GetGuildGoodsAsync("guildIndate");
```

### Callback 방식

```js
BackndGuild.Instance.GetGuildGoods("guildIndate", (callback) =>
{
  // 이후 처리
});
```
...
```js
public async Task GetGuildGoodsByIndateV3()
{
    var reqResult = await BackndGuild.Instance.GetGuildGoodsAsync("2021-12-16T08:51:00.706Z");
