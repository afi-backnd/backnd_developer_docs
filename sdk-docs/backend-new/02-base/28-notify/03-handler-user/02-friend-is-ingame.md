...
> 실시간 알림 서버 접속은 BackndBase.Notification.Connect() 함수를 통해 하실 수 있습니다.  
...
```js
BackndBase.Notification.OnFriendConnected = (string inDate, string nickname) => {
...
```js
BackndBase.Notification.OnFriendDisconnected= (string inDate, string nickname) => {
