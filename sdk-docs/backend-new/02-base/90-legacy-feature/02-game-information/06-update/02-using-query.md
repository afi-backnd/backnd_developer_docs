...
description: "데이터 수정 (쿼리이용)"
---

# Update
public Task&lt;RequestResult&gt; **UpdateAsync**(string **tableName**, Where **where**, Param **param**);
...
// 자신의 inDate의 row를 수정
var reqResult = await BackndLegacy.GameData.UpdateAsync("tableName", where, param);
```
