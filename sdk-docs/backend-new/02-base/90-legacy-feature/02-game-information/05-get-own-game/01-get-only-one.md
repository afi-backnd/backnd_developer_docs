...
# GetMyData
public Task&lt;RequestResult&gt; **GetMyDataAsync**(string **tableName**, string **inDate**);  
public Task&lt;RequestResult&gt; **GetMyDataAsync**(string **tableName**, string **inDate**, string[] **select**);
...
var reqResult = await BackndLegacy.GameData.GetMyDataAsync("tableName", "rowIndate");
Debug.Log(reqResult);

// 테이블 내 해당 rowIndate를 지닌 row를 조회
// select에 존재하는 컬럼만 리턴
reqResult = await BackndLegacy.GameData.GetMyDataAsync("tableName", "rowIndate", select);
Debug.Log(reqResult);
```
...
// 테이블 내 해당 rowIndate를 지닌 row를 조회
BackndLegacy.GameData.GetMyData("tableName", "rowIndate", (callback) =>
{
    Debug.Log(callback);
});
...
// 테이블 내 해당 rowIndate를 지닌 row를 조회
// select에 존재하는 컬럼만 리턴
BackndLegacy.GameData.GetMyData("tableName", "rowIndate", select, (callback) =>
{
    Debug.Log(callback);
});
```
...
{
    var reqRequest = await BackndLegacy.GameData.GetMyDataAsync("PlayerInfo", "2022-03-15T07:16:44.031Z");
    ...
    var gameDataListJson = reqRequest.GetJObject()["row"] as JObject;
