...
# TransactionWriteV2
public Task&lt;RequestResult&gt; **TransactionWriteV2Async**(ListTransactionValue[\] **transactionList**);  
public Task&lt;RequestResult&gt; **TransactionWriteV2Async**(List<TransactionValue\> **transactionList**);
...
transactionList.Add(TransactionValue.SetUpdateV2("tableName2", data_inDate, BackndBase.UserInDate, updateParam));
transactionList.Add(TransactionValue.SetDeleteV2("tableName2", data_inDate, BackndBase.UserInDate));
```

### Task 형식
```js
var reqResult = await BackndLegacy.GameData.TransactionWriteV2Async(transactionList);
```

### Callback 형식
```js
BackndLegacy.GameData.TransactionWriteV2(transactionList, (callback) => 
{
    // 이후 처리
});
```
