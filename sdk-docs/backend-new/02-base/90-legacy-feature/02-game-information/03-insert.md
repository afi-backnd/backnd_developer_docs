...
public Task&lt;RequestResult&gt; **InsertAsync**(string **tableName**);  
public Task&lt;RequestResult&gt; **InsertAsync**(string **tableName**, Param **param**);
...
### Task 형식
```js
var reqResult = await BackndLegacy.GameData.InsertAsync("tableName", param);
```

### Callback 형식
```js
BackndLegacy.GameData.Insert("tableName", param, (callback) =>
{
  // 이후 처리
});
```
...
{
    public string nickName = BackndBase.UserNickName;
    public string ownerIndate = BackndBase.UserInDate;
