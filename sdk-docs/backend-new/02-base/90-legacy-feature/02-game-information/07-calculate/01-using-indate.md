...
public Task&lt;RequestResult&gt; **UpdateWithCalculationV2Async**(string **tableName**, string **inDate**, string **owner_inDate**, Param **param**);
...
var reqResult = await BackndLegacy.GameData.UpdateWithCalculationV2Async("tableName", inDate, BackndBase.UserInDate, updateParam);

//타인의 inDate의 row를 사칙연산
var reqResult2 = await BackndLegacy.GameData.UpdateWithCalculationV2Async("tableName", inDate, "owner_inDate", updateParam);        
```
...
//자신의 inDate의 row를 사칙연산
BackndLegacy.GameData.UpdateWithCalculationV2("tableName", inDate, BackndBase.UserInDate, updateParam, callback =>
{
    // 이후 처리
});

//타인의 inDate의 row를 사칙연산
BackndLegacy.GameData.UpdateWithCalculationV2("tableName", inDate, "owner_inDate", updateParam, callback =>
{
    // 이후 처리
});
```
