...
description: "데이터 검색 후 연산 (쿼리이용)"
---

# UpdateWithCalculation
public Task&lt;RequestResult&gt; **UpdateWithCalculationAsync**(string **tableName**, Where **where**, Param **param**);
...
var reqResult = await BackndLegacy.GameData.UpdateWithCalculationAsync("tableName", where, updateParam);
```
...
BackndLegacy.GameData.UpdateWithCalculation("tableName", where, updateParam, callback =>
{
    // 이후 처리
});
```
