...
description: "[Deprecated] 차트 리스트 불러오기 V2"
---

# [Deprecated] GetChartListV2
public Task< RequestResult > **GetChartListV2Async**();
...
### Task 방식
```js
var reqResult = await BackndLegacy.Chart.GetChartListV2Async();
```

### Callback 방식
```js
BackndLegacy.Chart.GetChartListV2((callback) =>
{
    // 이후 작업
});
```
...
```js
public async Task GetChartListV2Test()
{
    var reqResult = await BackndLegacy.Chart.GetChartListV2Async();
