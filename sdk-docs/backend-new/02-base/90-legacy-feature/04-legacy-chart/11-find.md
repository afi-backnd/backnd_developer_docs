...
### 동기
```js
BackndLegacy.Chart.GetLocalChartData("chartKey");
```
...
뒤끝은 Newtonsoft json을 사용하여 구현되어 있으나 다른 것을 사용해도 무방합니다.  

```js
var chartJson = JObject.Parse(BackndLegacy.Chart.GetLocalChartData(ChartName));
