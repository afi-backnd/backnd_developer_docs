...
```js
// 랭킹 1위 부터 10위까지
var reqResult = await BackndLegacy.URank.Guild.GetPastRankListAsync("a61c6980-db5f-11ee-95a9-73cbb1225013", 10, 0);

// 랭킹 11위(offset + 1) 부터 111위까지((offset + 1 + limit)
var reqResult2 = await BackndLegacy.URank.Guild.GetPastRankListAsync("a61c6980-db5f-11ee-95a9-73cbb1225013", 100, 10);
```

### Callback 방식
```js
BackndLegacy.URank.Guild.GetPastRankList("a61c6980-db5f-11ee-95a9-73cbb1225013", 10, 0, callback =>
{
...
public async Task GetRankRewardList()
{
    ...
    var reqResult = await BackndLegacy.URank.Guild.GetPastRankListAsync(rankingUUID, 100, 0);
