...
var reqResult = await BackndLegacy.URank.User.UpdateUserScoreAsync
    ("aa6609c0-****-****-****-ffd79d523912", "DAILY_USER_RANK", rankDataIndate, rankParam);
```

### 데이터 조회

```js
var reqResult = await BackndLegacy.URank.User.GetRankListAsync("aa6609c0-****-****-****-ffd79d523912");
foreach (var json in reqResult.GetRows())
{
...
var reqResult = await BackndLegacy.URank.User.UpdateUserScoreAsync("aa6609c0-****-****-****-ffd79d523912", "DAILY_USER_RANK", rankDataIndate, rankParam);
